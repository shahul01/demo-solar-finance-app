...
import { projects, projectCosts, costLineItems, costCategories } from './db/schema.js';
import { eq, desc, and } from 'drizzle-orm';
import type { Project, ProjectCost, CostLineItem, CostCategory } from './db/schema.js';
